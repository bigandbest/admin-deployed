      ...
      <CardContent className="pt-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Select value={product.vertical} onValueChange={(value) => handleChange('vertical', value)}>
          ...
          <div className="space-y-2">
            ...
            <Select value={product.brand_id} onValueChange={(value) => handleChange('brand_id', value)}>
              <SelectTrigger className="bg-muted/50 border-input">
              ...
              <SelectContent>
                ...
                <SelectItem value="brand5">Columbia</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </div>
        ...
        <div className="space-y-4 p-4 bg-muted/30 rounded-lg border border-border">
          <div className="flex items-center justify-between">
            <Label htmlFor="return-toggle" className="text-sm font-medium cursor-pointer">
              Return Applicable
            </Label>
            <Switch
              id="return-toggle"
          ...
          {product.return_applicable && (
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleChange('return_days', Number(e.target.value))}
