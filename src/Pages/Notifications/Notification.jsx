...
export default function Notification() {
  ...
  const fetchNotifications = async () => {
    try {
      const res = await axios.get(`${API_BASE_URL}/notifications/collect`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        await axios.put(
          `${API_BASE_URL}/notifications/update/${editingId}`,
          payload
        );
      } else {
        await axios.post(`${API_BASE_URL}/notifications/create`, payload);
      }
  ...
  const handleDelete = async (id) => {
    if (!window.confirm("Are you sure you want to delete this notification?"))
      return;
    try {
      await axios.delete(`${API_BASE_URL}/notifications/delete/${id}`);
      fetchNotifications();
    } catch (err) {
