...
export default function SubStoreAdmin() {
  ...
  }/sub-stores`; /** Fetches all SubStores from the API and updates the state. */ // --- API Handlers ---
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setPreview(null);
      setEditingId(null); // Refresh the list of stores to show the new or updated entry.
      fetchStores();
    } catch (err) {
  ...
  const handleDelete = async (id) => {
    if (!window.confirm("Are you sure you want to delete this SubStore?"))
      return;
    try {
